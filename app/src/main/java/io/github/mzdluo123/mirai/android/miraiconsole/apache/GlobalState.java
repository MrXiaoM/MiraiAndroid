        ...
        implements Closeable
{
    ...
    static class CompoundKey
    {
        ...
        public boolean equals( Object obj )
        {
            ...
            GlobalState.CompoundKey that = (GlobalState.CompoundKey) obj;
    ...
    private final ConcurrentMap<GlobalState.CompoundKey, Object> userTokens;

    private final ConcurrentMap<HttpHost, AuthSchemePool> authSchemePools;

    private final ConcurrentMap<GlobalState.CompoundKey, Boolean> expectContinues;
    ...
    public Object getUserToken( GlobalState.CompoundKey key )
    {
        return userTokens.get( key );
    }

    public void setUserToken(GlobalState.CompoundKey key, Object userToken )
    {
        if ( userToken != null )
        {
    ...
    public Boolean getExpectContinue( GlobalState.CompoundKey key )
    {
